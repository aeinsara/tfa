...
def get_config(seed, shot):
    ...
    if args.coco:
        ...
        ITERS = {
            1: (28000,32000),#(3500, 4000),
            2: (56000, 64000),#(7000, 8000),
            3: (84000, 96000),#(10500, 12000),
            5: (140000, 160000),#(17500, 20000),
            10: (280000, 320000),#(35000, 40000),
        }
        mode = "all"
        split = temp_split = ""
        temp_mode = mode

        config_dir = "configs/DOTA-detection"
        ckpt_dir = "checkpoints/dota/faster_rcnn"
        base_cfg = "../../../Base-RCNN-FPN.yaml"
